...
def create_corpus(docs_iter, name):
    ...
    for doc in docs_iter:
        ...
        i += 1
    if name == "A":
        output_file = "C:/Users/User/Documents/train/Antique/corpus.json"
    if name == "Q":
        output_file = 'C:/Users/User/Documents/train/Quora/corpus.json'
...
def create_training_corpus(docs_iter, name):
    ...
    for doc in docs_iter:
        ...
        i += 1
    if name == "A":
        output_file = 'C:/Users/User/Documents/train/Antique/training_corpus.json'
    if name == "Q":
        output_file = 'C:/Users/User/Documents/train/Quora/training_corpus.json'
    with open(output_file, 'w') as f:
        json.dump(corpus, f)
...
def create_inverted_index(name):
    ...
    if name == "A":
        output_file = 'C:/Users/User/Documents/train/Antique/inverted_index.json'
    if name == "Q":
        output_file = 'C:/Users/User/Documents/train/Quora/inverted_index.json'
...
def calculate_doc_tfidf_vectors(inverted_index, name):
    if name == "A":
        output_file = 'C:/Users/User/Documents/train/Antique/tfidf_doc_vectors.json'
    if name == "Q":
        output_file = 'C:/Users/User/Documents/train/Quora/tfidf_doc_vectors.json'
...
def train_model(name,window):
    if name == "A":
        model_path = 'C:/Users/User/Documents/train/Antique/word_embedding_model.bin'
        output_file = 'C:/Users/User/Documents/train/Antique/document_embedding.json'
    if name == "Q":
        model_path = 'C:/Users/User/Documents/train/Quora/word_embedding_model.bin'
        output_file = 'C:/Users/User/Documents/train/Quora/document_embedding.json'
...
def load_document_embedding(name):
    if name == "A":
        model_path = 'C:/Users/User/Documents/train/Antique/document_embedding.json'
    if name == "Q":
        model_path = 'C:/Users/User/Documents/train/Quora/document_embedding.json'
...
def qrels_parsing(dataset, name):
    if name == "A":
        output_file = 'C:/Users/User/Documents/train/Antique/antique_qrels.json'
    if name == "Q":
        output_file = 'C:/Users/User/Documents/train/Quora/Quora_qrels.json'
    parsed_data = {}
...
def get_dataset_queries(dataset, name):
    if name == "A":
        output_file = 'C:/Users/User/Documents/train/Antique/queries.txt'
    if name == "Q":
        output_file = 'C:/Users/User/Documents/train/Quora/queries.txt'
    queries_list = []
