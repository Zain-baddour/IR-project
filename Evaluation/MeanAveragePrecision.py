...
def evaluate_mean_average_precision(queries, name):
    ...
    if name == "A":
        output_file = "D:/Information-Retrieval-System-main/Information-Retrieval-System-main/Evaluation/Results/Antique/TFIDF_MAP.txt"
    if name == "Q":
        output_file = "D:/Information-Retrieval-System-main/Information-Retrieval-System-main/Evaluation/Results/Quora/WE_MAP.txt"
