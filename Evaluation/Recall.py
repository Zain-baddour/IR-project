...
def evaluate_recall(queries, name):
    if name == "A":
        output_file = "D:/Information-Retrieval-System-main/Information-Retrieval-System-main/Evaluation/Results/Antique/TFIDF_Recall.txt"
    if name == "Q":
        output_file = "D:/Information-Retrieval-System-main/Information-Retrieval-System-main/Evaluation/Results/Quora/WE_Recall.txt"
