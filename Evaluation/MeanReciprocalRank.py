...
def evaluate_mean_reciprocal_rank(queries, name):
    if name == "A":
        output_file = "D:/Information-Retrieval-System-main/Information-Retrieval-System-main/Evaluation/Results/Antique/TFIDF_MRR.txt"
    if name == "Q":
        output_file = "D:/Information-Retrieval-System-main/Information-Retrieval-System-main/Evaluation/Results/Quora/WE_MRR.txt"
